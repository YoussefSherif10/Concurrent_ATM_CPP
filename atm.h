//
// Created by youssef fekry on 17/02/2023.
//
...
class Atm {
    ...
    void process_withdrawal () {
        incoming.wait().handle<withdraw_ok>([&](withdraw_ok const &msg){
            interface_hardware.send(withdrawal_amount);
            ...
            bank.send(cancel_withdraw(account, withdrawal_amount));
