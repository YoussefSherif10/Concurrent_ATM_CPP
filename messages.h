//
// Created by youssef fekry on 15/02/2023.
// each message is represented by a separate struct

#ifndef ATM_MESSAGES_H
#define ATM_MESSAGES_H
...
struct cancel_withdraw {
    ...
    cancel_withdraw(std::string const &account_, unsigned amount_): account(account_), amount(amount_) {}
};
